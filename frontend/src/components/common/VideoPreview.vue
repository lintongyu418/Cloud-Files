<template>
  <transition name="el-zoom-in-top">
    <div v-show="videoPreviewVisible" class="video-preview-wrapper">
      <div class="top">
        ...
        <a
          ...
          class="download-link"
          target="_blank"
        ><i class="download-icon el-icon-download" title="下载"/></a>
        <i
        ...
        />
        <i class="close-icon el-icon-close" title="关闭" @click="handleClosePreview"/>
      </div>
      <div class="bottom">
        <video-player
        ...
        <el-collapse-transition>
          <div v-show="!isFoldVideoList" class="video-list-wrapper">
