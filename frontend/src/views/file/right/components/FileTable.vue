<template>
  <div class="file-table-wrapper">
    ...
    >
      ...
      <el-table-column key="isDir" prop="isDir" width="60" align="center">
      ...
      >
        <template slot-scope="scope">
          <div>
            <i v-if="getFileShareStatus(scope.row.endTime)" class="el-icon-warning"/>
