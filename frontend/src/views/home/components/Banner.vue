<template>
  <el-carousel height="580px" class="el-carousel">
    <el-carousel-item v-for="(item, index) in bannerList" :key="index" class="carosel-inner">
...
export default {
  ...
  data() {
    return {
      bannerList: [
        {
          title: 'A file cloud Application',
          descList: ['Sate to upload', 'Unzip online', 'Recycle'],
          btn: 'Use it right now',
